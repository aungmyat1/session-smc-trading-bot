...
def backup_main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Create an encrypted PostgreSQL control-plane backup.")
...
def restore_main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Restore an encrypted PostgreSQL control-plane backup.")
