...
from execution.metaapi_client import AccountInfo, MetaAPIClient, OrderResult
...
class TestConnectedState:
    ...
    async def test_get_candles_prefers_account_historical_candles(self):
        ...
        client._account.get_historical_candles = AsyncMock(
            return_value=[
                {
        ...
        client._connection.get_historical_candles = AsyncMock(
            side_effect=AssertionError("should not use connection fallback")
        )
    ...
    async def test_get_candles_uses_connection_fallback_when_account_missing(self):
        ...
        client._connection.get_candles = AsyncMock(
            return_value=[
                {
                    "time": "2026-06-26T00:00:00Z",
                    "open": 1.1,
