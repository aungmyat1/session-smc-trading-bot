...
| ST-B1_v1 | 2026-07-12 | Simple Trend Pullback: H1 EMA200 trend filter → M15 EMA20 pullback/rejection → next candle open; fixed 1:2 RR; 0.25% risk reference; London/NY only. Run ID `ST-B1-20260712T153115-49638d`. | H1+M15 | EUR+GBP | 2319 | — | EURUSD 1.4pip / GBPUSD 1.8pip RT (std), 2.8/3.6pip (2×) | 0.834 | 0.675 | 34.5% | **FAIL** — PF, Sharpe, and MaxDD fail at standard and 2× stress. Sharpe std=-0.088 / 2×=-0.196; MaxDD std=76.31% / 2×=164.36%. Walk-forward: 0/6 windows pass. See `reports/st_b1_validation_report.md` and `reports/st_b1_failure_analysis.md`. |
