  ...
  if (!virtualDemo) {
    return (
      <div className="bg-white border border-slate-200 rounded-lg p-8 text-center text-slate-500">
        ...
        <p className="font-semibold text-sm">No Broker Emulation Generated</p>
        <p className="text-xs text-slate-500 mt-1">Please promote your strategy to the Virtual Demo stage to establish broker simulation feeds.</p>
      </div>
    );
  }
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-5 shadow-sm space-y-4">
          <h3 className="font-display font-semibold text-slate-900 text-sm flex items-center space-x-1.5 border-b border-slate-100 pb-2">
          ...
          <div className="grid grid-cols-2 gap-3 text-xs font-mono">
            <div className="bg-slate-50 border border-slate-100 p-3 rounded-md">
              <span className="text-[9px] text-slate-400 block uppercase">Submitted</span>
              <span className="text-base font-bold text-slate-900">{ordersSubmitted}</span>
            </div>
            <div className="bg-slate-50 border border-slate-100 p-3 rounded-md">
              <span className="text-[9px] text-slate-400 block uppercase">Filled</span>
              <span className="text-base font-bold text-emerald-600">{ordersFilled}</span>
            </div>
            <div className="bg-slate-50 border border-slate-100 p-3 rounded-md">
              <span className="text-[9px] text-slate-400 block uppercase">Rejected</span>
              <span className="text-base font-bold text-red-600">{ordersRejected}</span>
            </div>
            <div className="bg-slate-50 border border-slate-100 p-3 rounded-md">
              <span className="text-[9px] text-slate-400 block uppercase">Avg Latency</span>
              <span className="text-base font-bold text-slate-900">{virtualDemo.averageLatencyMs.toFixed(1)}ms</span>
            </div>
          </div>
        </div>
      </div>
