...
export default function VersionHistoryChart({ strategy, compareStrategy }: VersionHistoryChartProps) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm space-y-5" id="registry-trend-chart-card">
      <div className="flex flex-col xl:flex-row xl:justify-between xl:items-start border-b border-slate-100 pb-4 gap-4">
        <div>
          <span className="text-[10px] font-mono text-indigo-600 font-semibold uppercase tracking-widest block flex items-center space-x-1">
        ...
        <div className="flex flex-wrap gap-3 items-center self-start xl:self-center">
          ...
          <div className="flex items-center space-x-2 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-md text-[10px] font-mono">
            <span className="text-slate-500 font-medium">Trend (SMA):</span>
            <button
            ...
            {showSMA && (
              <select
                ...
                className="bg-white border border-slate-200 text-[9px] font-mono rounded px-1 py-0.5 text-slate-700 focus:ring-1 focus:ring-indigo-500 focus:outline-none"
          ...
          {isComparisonMode && (
            <div className="flex bg-slate-100 p-1 rounded-md text-[10px] font-mono">
        ...
        {!isComparisonMode && (
          <div className="flex flex-wrap gap-2 text-[10px] font-mono self-start xl:self-center">
            <div className="bg-indigo-50 border border-indigo-100 text-indigo-700 px-2 py-1 rounded flex items-center space-x-1">
              <span>Audit:</span>
              <span className="font-bold">+{auditImprovementA >= 0 ? "" : ""}{auditImprovementA}pts</span>
            </div>
            <div className="bg-purple-50 border border-purple-100 text-purple-700 px-2 py-1 rounded flex items-center space-x-1">
              <span>Safety:</span>
