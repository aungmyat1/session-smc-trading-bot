    ...
    <div className="bg-zinc-900 border border-zinc-800/80 rounded-2xl p-4 shadow-lg flex flex-col gap-3">
      ...
      {isOpen && (
        <div className="mt-2.5 flex flex-col gap-6 pt-3.5 border-t border-zinc-800/60 transition-all duration-300">
          ...
          {/* Python smart-money-concepts Indicator Package Integration */}
          <div className="flex flex-col gap-4 bg-zinc-950/40 border border-zinc-850 p-4 rounded-xl mt-2">
            <div className="flex items-center gap-2 border-b border-zinc-800/40 pb-2">
              <span className="w-2 h-2 rounded-full bg-indigo-400 animate-pulse"></span>
              <h4 className="font-sans font-bold text-zinc-200 text-xs uppercase tracking-wider">
                Python smart-money-concepts (SMC) Indicator Integration Reference
              </h4>
            </div>
            
            <p className="text-xs font-sans text-zinc-400 leading-relaxed">
              This bot aligns directly with the specifications of the core Python <code className="text-indigo-400 bg-zinc-950 px-1.5 py-0.5 rounded font-mono font-bold">smart-money-concepts</code> package. Below are the specific indicators utilized by the strategy pipeline to qualify session-level sweeps, structural shifts, and entries:
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3.5 mt-1">
              <div className="p-3 bg-zinc-900/50 border border-zinc-800 rounded-xl flex flex-col gap-1.5">
                <span className="font-mono text-[10px] text-indigo-400 font-bold">1. SESSIONS RANGE</span>
                <p className="text-[11px] text-zinc-400 font-sans leading-relaxed">
                  Maps High/Low extremes of the Asian Session (00:00 - 08:00 UTC) as primary liquidity zones to target for sweeps during the London and NY Kill Zones.
                </p>
              </div>

              <div className="p-3 bg-zinc-900/50 border border-zinc-800 rounded-xl flex flex-col gap-1.5">
                <span className="font-mono text-[10px] text-indigo-400 font-bold">2. SWING HIGH / LOW</span>
                <p className="text-[11px] text-zinc-400 font-sans leading-relaxed">
                  Calculates fractal highs and lows of the day, creating dynamically updated support/resistance bounds and Previous Day High/Low indicators.
                </p>
              </div>

              <div className="p-3 bg-zinc-900/50 border border-zinc-800 rounded-xl flex flex-col gap-1.5">
                <span className="font-mono text-[10px] text-indigo-400 font-bold">3. BOS &amp; CHOCH</span>
                <p className="text-[11px] text-zinc-400 font-sans leading-relaxed">
                  Triggers trend structure shifts (BOS) and local trend changes of character (CHoCH) on 1M/5M charts, confirming market structure shifts.
                </p>
              </div>

              <div className="p-3 bg-zinc-900/50 border border-zinc-800 rounded-xl flex flex-col gap-1.5">
                <span className="font-mono text-[10px] text-indigo-400 font-bold">4. RETRACEMENTS (FIB)</span>
                <p className="text-[11px] text-zinc-400 font-sans leading-relaxed">
                  Supplements entry filtering with Premium and Discount zones. Ensures the bot buys ONLY in deep discount (below 50% fib of the swing leg).
                </p>
              </div>
            </div>
          </div>
