...
def test_build_recovery_summary_reflects_loaded_state_and_journal(tmp_path, monkeypatch):
    ...
    journal.signal_created("EURUSD", "london", "long", 1.08, 1.07, 1.10, 10.0, signal_ts="2026-06-27T08:00:00Z")
    journal.order_submitted("EURUSD", "london", "long", 0.01, 1.07, 1.10, 0.01, 10_000.0, 1.0)
