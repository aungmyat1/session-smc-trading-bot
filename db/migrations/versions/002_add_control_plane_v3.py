...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_gd_strategy_id", "gate_decision", ["strategy_id"], schema="governance"
    )
    op.create_index(
        "idx_gd_decided_at", "gate_decision", ["decided_at"], schema="governance"
    )
    ...
    op.create_index(
        "idx_appr_strategy_id", "approval", ["strategy_id"], schema="governance"
    )
    ...
    op.create_index(
        "idx_ea_strategy_stage", "artifact", ["strategy_id", "stage"], schema="evidence"
    )
    ...
    op.create_index(
        "idx_eb_strategy_stage", "binding", ["strategy_id", "stage"], schema="evidence"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "run_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("research.run.id")
        ),
        sa.Column(
            "strategy_id",
            postgresql.UUID(as_uuid=True),
    ...
    op.create_index(
        "idx_sg_strategy_id", "stage_gate", ["strategy_id"], schema="analytics"
    )
    ...
    op.create_index(
        "idx_exp_strategy_id", "experiment", ["strategy_id"], schema="experiments"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "experiment_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("experiments.experiment.id"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_ps_experiment_id", "parameter_set", ["experiment_id"], schema="experiments"
    )
    ...
    op.create_index(
        "idx_wfr_run_id", "walk_forward_result", ["run_id"], schema="robustness"
    )
    ...
    op.create_index(
        "idx_mcr_run_id", "monte_carlo_result", ["run_id"], schema="robustness"
    )
    ...
    op.create_index(
        "idx_sr_run_id", "sensitivity_result", ["run_id"], schema="robustness"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "order_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("execution.virtual_order.id"),
            nullable=False,
        ),
        sa.Column("symbol", sa.String(20), nullable=False),
        sa.Column("direction", sa.String(10), nullable=False),
    ...
    op.create_index(
        "idx_do_run_id", "drift_observation", ["run_id"], schema="execution"
    )
    ...
    op.create_index(
        "idx_dep_strategy_id", "deployment", ["strategy_id"], schema="operations"
    )
    ...
    op.create_index(
        "idx_inc_strategy_id", "incident", ["strategy_id"], schema="operations"
    )
    op.create_index(
        "idx_inc_deployment_id", "incident", ["deployment_id"], schema="operations"
    )
