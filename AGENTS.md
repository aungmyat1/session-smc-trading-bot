# Strategy Engineering Platform — Agent Instructions
# v2.0 | read every session | applies to ALL coding agents (Codex, Cursor, Claude Code, etc.)
#
# This file mirrors CLAUDE.md, the canonical instruction set for this repo. If the two
# ever diverge, CLAUDE.md wins — update this file to match rather than editing rules here.
